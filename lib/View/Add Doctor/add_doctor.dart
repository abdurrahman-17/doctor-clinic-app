...
class _AddDoctorState extends State<AddDoctor> {
  AddDoctorNotifier addDoctorNotifier = AddDoctorNotifier();
  ...
  Widget build(BuildContext context) {
    if (!kReleaseMode) {}
    return Consumer<AddDoctorNotifier>(
  ...
  Widget imageAndTextField(context) {
    addDoctorNotifier =
        Provider.of<AddDoctorNotifier?>(context, listen: false)!;
    return Column(
      children: [
        Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_key.currentState!.validate()) {
                            addDoctorNotifier.addDoctorInfo(
                              doctorId,
