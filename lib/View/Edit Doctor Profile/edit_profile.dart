...
class _EditProfileState extends State<EditProfile> {
  UpdateDoctorProfileNotifier updateDoctorProfileNotifier =
  ...
  Widget imageAndTextField(context) {
    updateDoctorProfileNotifier =
        Provider.of<UpdateDoctorProfileNotifier>(context, listen: false);
    return Column(
      children: [
        Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_key.currentState!.validate()) {
                            updateDoctorProfileNotifier.updateDoctorProfileInfo(
