...
//
//     final todayCheckedInResponse = todayCheckedInResponseFromJson(jsonString);

import 'dart:convert';

TodayCheckedInResponse todayCheckedInResponseFromJson(String str) =>
    TodayCheckedInResponse.fromJson(json.decode(str));

String todayCheckedInResponseToJson(TodayCheckedInResponse data) =>
    json.encode(data.toJson());

class TodayCheckedInResponse {
  TodayCheckedInResponse({
    this.status,
    this.message,
    this.data,
  });
  ...
  bool? status;
  String? message;
  List<CheckedInData>? data;

  factory TodayCheckedInResponse.fromJson(Map<String, dynamic> json) =>
      TodayCheckedInResponse(
        status: json["status"] == null ? null : json["status"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null
            ? null
            : List<CheckedInData>.from(
                json["data"].map((x) => CheckedInData.fromJson(x))),
      );
...
class CheckedInData {
  ...
  factory CheckedInData.fromJson(Map<String, dynamic> json) => CheckedInData(
