...
//
//     final registeredPatientFilterResponse = registeredPatientFilterResponseFromJson(jsonString);

import 'dart:convert';

RegisteredPatientFilterResponse registeredPatientFilterResponseFromJson(String str) => RegisteredPatientFilterResponse.fromJson(json.decode(str));

String registeredPatientFilterResponseToJson(RegisteredPatientFilterResponse data) => json.encode(data.toJson());

class RegisteredPatientFilterResponse {
  RegisteredPatientFilterResponse({
    this.status,
    this.message,
    this.data,
  });
  ...
  bool? status;
  String? message;
  List<RegisteredFilterData>? data;

  factory RegisteredPatientFilterResponse.fromJson(Map<String, dynamic> json) => RegisteredPatientFilterResponse(
    status: json["status"] == null ? null : json["status"],
    message: json["message"] == null ? null : json["message"],
    data: json["data"] == null ? null : List<RegisteredFilterData>.from(json["data"].map((x) => RegisteredFilterData.fromJson(x))),
  );
...
class RegisteredFilterData {
  RegisteredFilterData({
    this.id,
    this.patientId,
    this.walkinId,
    this.doctorId,
  ...
  factory RegisteredFilterData.fromJson(Map<String, dynamic> json) => RegisteredFilterData(
