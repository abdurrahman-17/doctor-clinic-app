...
//
//     final emergencyAppointmentListResponse = emergencyAppointmentListResponseFromJson(jsonString);

import 'dart:convert';

EmergencyAppointmentListResponse emergencyAppointmentListResponseFromJson(String str) => EmergencyAppointmentListResponse.fromJson(json.decode(str));

String emergencyAppointmentListResponseToJson(EmergencyAppointmentListResponse data) => json.encode(data.toJson());

class EmergencyAppointmentListResponse {
  EmergencyAppointmentListResponse({
    this.status,
    this.message,
    this.data,
  });
  ...
  bool? status;
  String? message;
  List<EmergencyListData>? data;

  factory EmergencyAppointmentListResponse.fromJson(Map<String, dynamic> json) => EmergencyAppointmentListResponse(
    status: json["status"] == null ? null : json["status"],
    message: json["message"] == null ? null : json["message"],
    data: json["data"] == null ? null : List<EmergencyListData>.from(json["data"].map((x) => EmergencyListData.fromJson(x))),
  );
...
class EmergencyListData {
  ...
  factory EmergencyListData.fromJson(Map<String, dynamic> json) => EmergencyListData(
