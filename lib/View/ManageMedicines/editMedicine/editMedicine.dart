...
class _EditMedicineState extends State<EditMedicine> {
  ...
  EditMedicineNotifier editMedicineNotifier = EditMedicineNotifier();
  ...
  void initState() {
    ...
    dosageController.text = widget.dosage == 'null' ? "" : widget.dosage;
    brandNameController.text = widget.brandName;
    print(widget.brandName);
    dropDownBrandName = widget.brandName == '' ? "" : widget.brandName;
    dropDownMeasurment =
        widget.contentMeasurement == 'null' ? null : widget.contentMeasurement;
    dropDownCategory =
        widget.categoryName == 'null' ? null : widget.categoryName;
    Future.delayed(Duration.zero, () async {
      ...
      for (int i = 0;
          ...
          i++) {
        print('hello');
        if (getMedicineCategoryNotifier.getCategoryClass[i].categoryName ==
            dropDownCategory) {
          dropDownCategoryId =
              getMedicineCategoryNotifier.getCategoryClass[i].id;
  ...
  Widget build(BuildContext context) {
    return Consumer<EditMedicineNotifier>(
      builder: (context, provider, _) {
        editMedicineNotifier = provider;
        return ModalProgressHUD(
          inAsyncCall: editMedicineNotifier.isLoading,
          child: Scaffold(
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            if (productController.text.isNotEmpty) {
              editMedicineNotifier.editMedicine(
