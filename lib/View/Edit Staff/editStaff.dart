...
class _EditStaffState extends State<EditStaff> {
  UpdateStaffProfileNotifier updateStaffProfileNotifier =
  ...
  Widget imageAndTextField(context) {
    updateStaffProfileNotifier =
        Provider.of<UpdateStaffProfileNotifier?>(context, listen: false)!;
    return Column(
      children: [
        Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_key.currentState!.validate()) {
                            print(widget.staffId);
                            updateStaffProfileNotifier.updateStaffProfileInfo(
