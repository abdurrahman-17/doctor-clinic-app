import 'package:doctor_clinic_token_app/View/AbouUs/updateAboutUs.dart';
...
class _AboutUsState extends State<AboutUs> {
  AboutUsNotifier provider = AboutUsNotifier();
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      provider.aboutUS(doctorId);
      provider.notifyListeners();
      print(provider.aboutUsResponseClass);
  ...
  Widget build(BuildContext context) {
    return Consumer<AboutUsNotifier>(
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => UpdateAboutUs(
                                id: provider.aboutUsResponseClass[0].id ?? 0,
                                content: provider.aboutUsResponseClass[0]
                                        .clinicAboutUs ??
                                    "",
                                doctorId: doctorId,
                              ),
                ...
                body: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ),
                      Image.asset(
                        'assets/hand-drawn-nurse-team-background_52683-9108.jpg',
                        height: 300,
                      ...
                      // ),
                      Html(
                          data: provider.aboutUsResponseClass.isEmpty
                              ? ""
                              : provider.aboutUsResponseClass[0].clinicAboutUs)
                    ],
                  ),
                ),
              ),
