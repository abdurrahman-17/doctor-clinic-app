...
class EditUserDoctor extends StatefulWidget {
  String userId;
  String fullName;
  String email;
  String mobNumber;
  ...
  @override
  _EditUserDoctorState createState() => _EditUserDoctorState();
}

class _EditUserDoctorState extends State<EditUserDoctor> {
  EditUserDoctorNotifier editUserDoctorNotifier = EditUserDoctorNotifier();
  ...
  Widget build(BuildContext context) {
    if (!kReleaseMode) {}
    return Consumer<EditUserDoctorNotifier>(
  ...
  Widget imageAndTextField(context) {
    editUserDoctorNotifier =
        Provider.of<EditUserDoctorNotifier>(context, listen: false);
    return Column(
      children: [
        Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_key.currentState!.validate()) {
                            editUserDoctorNotifier.editUserDoctorProfileInfo(
