...
import 'package:doctor_clinic_token_app/utils/common/DATE/date_widget.dart';
import 'package:doctor_clinic_token_app/utils/common/DATE/extra/color.dart';
import 'package:doctor_clinic_token_app/utils/common/DATE/extra/style.dart';
import 'package:doctor_clinic_token_app/utils/common/DATE/gestures/tap.dart';
          ...
          return Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: Color(0xff6B779A).withOpacity(0.1))
              ),
              child: DateWidget(
                date: date,
