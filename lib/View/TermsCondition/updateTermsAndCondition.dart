...
class UpdateTermsAndCondition extends StatefulWidget {
  final id;
  final doctorId;
  final content;

  UpdateTermsAndCondition({Key? key, this.id, this.content, this.doctorId})
      : super(key: key);

  @override
  State<UpdateTermsAndCondition> createState() =>
      _UpdateTermsAndConditionState();
}

class _UpdateTermsAndConditionState extends State<UpdateTermsAndCondition> {
    ...
    return Consumer<UpdatePolicyNotifier>(
      builder: (context, provider, _) {
        ...
        return ModalProgressHUD(
          ...
          child: Scaffold(
            appBar: AppBar(
              title: const Text('Update Terms And Condition'),
              actions: [
                IconButton(
                  onPressed: () async {
