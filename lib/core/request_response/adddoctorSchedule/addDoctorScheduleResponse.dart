...
//
//     final addDoctorScheduleResponse = addDoctorScheduleResponseFromJson(jsonString);

import 'dart:convert';

AddDoctorScheduleResponse addDoctorScheduleResponseFromJson(String str) => AddDoctorScheduleResponse.fromJson(json.decode(str));

String addDoctorScheduleResponseToJson(AddDoctorScheduleResponse data) => json.encode(data.toJson());

class AddDoctorScheduleResponse {
  AddDoctorScheduleResponse({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory AddDoctorScheduleResponse.fromJson(Map<String, dynamic> json) => AddDoctorScheduleResponse(
