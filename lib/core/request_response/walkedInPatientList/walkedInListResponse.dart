...
//
//     final walkedInListResponse = walkedInListResponseFromJson(jsonString);

import 'dart:convert';

WalkedInListResponse walkedInListResponseFromJson(String str) => WalkedInListResponse.fromJson(json.decode(str));

String walkedInListResponseToJson(WalkedInListResponse data) => json.encode(data.toJson());

class WalkedInListResponse {
  WalkedInListResponse({
    this.status,
    this.message,
    this.data,
  });
  ...
  bool? status;
  String? message;
  List<WalkedInListData>? data;

  factory WalkedInListResponse.fromJson(Map<String, dynamic> json) => WalkedInListResponse(
    status: json["status"] == null ? null : json["status"],
    message: json["message"] == null ? null : json["message"],
    data: json["data"] == null ? null : List<WalkedInListData>.from(json["data"].map((x) => WalkedInListData.fromJson(x))),
  );
...
class WalkedInListData {
  ...
  factory WalkedInListData.fromJson(Map<String, dynamic> json) => WalkedInListData(
