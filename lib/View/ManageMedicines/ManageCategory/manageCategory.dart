...
import 'package:doctor_clinic_token_app/core/request_response/deleteCategory/deleteCategoryNotifier.dart';
import 'package:doctor_clinic_token_app/core/request_response/editCategory/editCategoryNotifier.dart';
...
class _ManageCategoryState extends State<ManageCategory> {
  ...
  DeleteCategoryNotifier deleteCategoryNotifier = DeleteCategoryNotifier();
  EditCategoryNotifier editCategoryNotifier = EditCategoryNotifier();
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      getMedicineCategoryNotifier.notifyListeners();
      for (int i = 0;
          i < getMedicineCategoryNotifier.getCategoryClass.length;
          i++) {
        _controllers.add(
          TextEditingController(
            text: getMedicineCategoryNotifier.getCategoryClass[i].categoryName,
          ),
        );
        isBool.add(true);
      }
  ...
  Widget build(BuildContext context) {
    return Consumer<GetMedicineCategoryNotifier>(
      builder: (context, provider, _) {
        getMedicineCategoryNotifier = provider;
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: Container(
              ...
              child: GestureDetector(
                onTap: () {
                  addCategoryNotifier.addCategory(
                    doctorId,
    ...
    return Expanded(
      child: _controllers.isEmpty
          ...
          : ListView.builder(
              ...
              itemCount: getMedicineCategoryNotifier.getCategoryClass.length,
                    ...
                    trailing: Row(
                      ...
                      children: [
                        isBool[index] == true
                            ...
                            : IconButton(
                                onPressed: () {
                                  editCategoryNotifier.editCategory(
                                    getMedicineCategoryNotifier
                                        .getCategoryClass[index].id!,
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                setState(() {
                  deleteCategoryNotifier.deleteCategory(
                    int.parse(id),
                  );
                });
              },
