...
//
//     final todayDoneAppointmentResponse = todayDoneAppointmentResponseFromJson(jsonString);

import 'dart:convert';

TodayDoneAppointmentResponse todayDoneAppointmentResponseFromJson(String str) =>
    TodayDoneAppointmentResponse.fromJson(json.decode(str));

String todayDoneAppointmentResponseToJson(TodayDoneAppointmentResponse data) =>
    json.encode(data.toJson());

class TodayDoneAppointmentResponse {
  TodayDoneAppointmentResponse({
    this.status,
    this.message,
    this.data,
  });
  ...
  bool? status;
  String? message;
  List<DoneAppointmentData>? data;

  factory TodayDoneAppointmentResponse.fromJson(Map<String, dynamic> json) =>
      TodayDoneAppointmentResponse(
        status: json["status"] == null ? null : json["status"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null
            ? null
            : List<DoneAppointmentData>.from(
                json["data"].map((x) => DoneAppointmentData.fromJson(x))),
      );
...
class DoneAppointmentData {
  ...
  factory DoneAppointmentData.fromJson(Map<String, dynamic> json) =>
      DoneAppointmentData(
