...
class DoneAppointment extends StatefulWidget {
  ...
  @override
  _DoneAppointmentState createState() => _DoneAppointmentState();
}
...
class _DoneAppointmentState extends State<DoneAppointment> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      provider.todayDoneAppointment(33).then((value) {
  ...
  Widget listViewNotCheckedIn(context) {
    return ListView.builder(
      ...
      itemCount: provider.todayDoneAppointmentClass.length,
